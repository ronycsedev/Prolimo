jQuery(document).ready(function($){
	...
	var animationDelay = 0,
		//loading bar effect
		barAnimationDelay = 8000,
		barWaiting = barAnimationDelay - 4000, //3000 is the duration of the transition on the loading bar - set in the scss/css file
		//letters effect
		lettersDelay = 600,
		//type effect
		typeLettersDelay = 2200,
		selectionDuration = 1600,
		typeAnimationDelay = selectionDuration + 1900,
		//typing effect 
		revealDuration = 2200,
