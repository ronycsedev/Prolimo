(function ($) {
  ...
  function limoking_car_ajax(car_holder, ajax_info, category, paged) {
    ...
    args["thumbnail-size-featured"] = ajax_info.attr(
      "data-thumbnail-size-featured"
    );
  ...
  $.fn.limoking_bind_car_pagination = function () {
    $(this).click(function () {
      ...
      var car_holder = $(this)
        .parent(".limoking-pagination")
        .siblings(".car-item-holder");
      var ajax_info = $(this)
        .parent(".limoking-pagination")
        .siblings(".limoking-ajax-info");

      var category = $(this)
        .parent(".limoking-pagination")
        .siblings(".car-item-filter");
      if (category) {
      ...
      $(this)
        ...
        .hover(
          function () {
            ...
            $(this)
              .find(".car-overlay-content, .car-overlay-icon")
  ...
  $(document).ready(function () {
    ...
    $(
      ".limoking-pagination.limoking-ajax .page-numbers"
    ).limoking_bind_car_pagination();
  });
})(jQuery);
