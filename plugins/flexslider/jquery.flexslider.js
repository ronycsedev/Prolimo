...
(function ($) {
  ...
  $.lmk_flexslider = function (el, options) {
    var slider = $(el);

    // making variables public
    slider.vars = $.extend({}, $.lmk_flexslider.defaults, options);
    ...
    methods = {
          ...
          if (!msGesture) {
            slider.slides.click(function (e) {
              ...
              if (
                ...
                !$(slider.vars.asNavFor).data("lmk_flexslider").animating &&
                !$slide.hasClass(namespace + "active-slide")
              ) {
                slider.direction =
      ...
      sync: function (action) {
        var $obj = $(slider.vars.sync).data("lmk_flexslider"),
    ...
    slider.flexAnimate = function (target, pause, override, withSync, fromNav) {
      ...
      if (
        ...
        if (asNav && withSync) {
          var master = $(slider.vars.asNavFor).data("lmk_flexslider");
    ...
    slider.doMath = function () {
      ...
      // gdlr modify
      var is_responsive = !$("body")
        .children()
        .hasClass("limoking-no-responsive");
  ...
  $.fn.lmk_flexslider = function (options) {
    ...
    if (typeof options === "object") {
      return this.each(function () {
        ...
        } else if ($this.data("lmk_flexslider") === undefined) {
          new $.lmk_flexslider(this, options);
        }
      });
    } else {
      // Helper strings to quickly perform functions on the slider
      var $slider = $(this).data("lmk_flexslider");
      switch (options) {
        case "play":
          $slider.play();
          break;
